...
?>>
    ...
    <title><?php echo htmlspecialchars( $og['title'] ) . ( $page_url === Facebook_Sample_Application::BASE_URI ? '' : ' | Scrumptious (powered by Temboo)' ); ?></title>
...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container-fluid">
            <a class="brand" href="<?php echo htmlspecialchars(Facebook_Sample_Application::BASE_URI); ?>">Scrumptious (powered by Temboo)</a>
            <p id="user-identity" class="navbar-text pull-right">
                <?php if (array_key_exists('facebook_access_token', $_SESSION)) { ?>
                    <a class="logout-link" href="<?php echo Facebook_Sample_Application::BASE_URI . 'tumptious.php/fblogout'; ?>">
                        <button id="inout-button" type="button" class="btn btn-primary logout-button">Logout</button>
                    </a>
                <?php } else { ?> 
                    <a href="<?php echo Facebook_Sample_Application::BASE_URI . 'tumptious.php/fbauthinit'; ?>">
                        <button id="inout-button" type="button" class="btn btn-primary login-button">Login</button>
                    </a>
                <?php } ?>
            </p>
        </div>
